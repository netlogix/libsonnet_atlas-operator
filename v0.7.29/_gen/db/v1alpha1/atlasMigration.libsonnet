{
  ...
  '#':: d.pkg(name='atlasMigration', url='', help='"AtlasMigration is the Schema for the atlasmigrations API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AtlasMigration', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'db.atlasgo.io/v1alpha1',
    kind: 'AtlasMigration',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AtlasMigrationSpec defines the desired state of AtlasMigration"'),
  spec: {
    '#cloud':: d.obj(help='"Cloud defines the Atlas Cloud configuration."'),
    cloud: {
      '#tokenFrom':: d.obj(help='"TokenFrom defines a reference to a secret key that contains the Atlas Cloud Token"'),
      tokenFrom: {
      ...
      withProject(project): { spec+: { cloud+: { project: project } } },
      '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { cloud+: { url: url } } },
    },
    ...
    '#dir':: d.obj(help='"Dir defines the directory to use for migrations as a configmap key reference."'),
    dir: {
      '#configMapRef':: d.obj(help='"ConfigMapRef defines the configmap to use for migrations"'),
      configMapRef: {
        '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { dir+: { configMapRef+: { name: name } } } },
      },
      '#remote':: d.obj(help='"Remote defines the Atlas Cloud migration directory."'),
      remote: {
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { dir+: { remote+: { name: name } } } },
        '#withTag':: d.fn(help='', args=[d.arg(name='tag', type=d.T.string)]),
        withTag(tag): { spec+: { dir+: { remote+: { tag: tag } } } },
      },
      '#withLocal':: d.fn(help='"Local defines the local migration directory."', args=[d.arg(name='Local', type=d.T.object)]),
      withLocal(Local): { spec+: { dir+: { 'local': Local } } },
      '#withLocalMixin':: d.fn(help='"Local defines the local migration directory."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='Local', type=d.T.object)]),
      withLocalMixin(Local): { spec+: { dir+: { 'local'+: Local } } },
    },
    '#protectedFlows':: d.obj(help='"ProtectedFlows defines the protected flows of a deployment."'),
    protectedFlows: {
      '#migrateDown':: d.obj(help='"DeploymentFlow defines the flow of a deployment."'),
      migrateDown: {
        '#withAllow':: d.fn(help='"Allow allows the flow to be executed."', args=[d.arg(name='allow', type=d.T.boolean)]),
        withAllow(allow): { spec+: { protectedFlows+: { migrateDown+: { allow: allow } } } },
        '#withAutoApprove':: d.fn(help='"AutoApprove allows the flow to be automatically approved."', args=[d.arg(name='autoApprove', type=d.T.boolean)]),
        withAutoApprove(autoApprove): { spec+: { protectedFlows+: { migrateDown+: { autoApprove: autoApprove } } } },
      },
    },
    ...
    '#withBaseline':: d.fn(help='"BaselineVersion defines the baseline version of the database on the first migration."', args=[d.arg(name='baseline', type=d.T.string)]),
    withBaseline(baseline): { spec+: { baseline: baseline } },
    ...
    '#withExecOrder':: d.fn(help='"ExecOrder controls how Atlas computes and executes pending migration files to the database."', args=[d.arg(name='execOrder', type=d.T.string)]),
    withExecOrder(execOrder): { spec+: { execOrder: execOrder } },
    '#withRevisionsSchema':: d.fn(help='"RevisionsSchema defines the schema that revisions table resides in"', args=[d.arg(name='revisionsSchema', type=d.T.string)]),
    withRevisionsSchema(revisionsSchema): { spec+: { revisionsSchema: revisionsSchema } },
