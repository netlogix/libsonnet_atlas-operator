{
  ...
  '#':: d.pkg(name='atlasSchema', url='', help='"AtlasSchema is the Schema for the atlasschemas API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AtlasSchema', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'db.atlasgo.io/v1alpha1',
    kind: 'AtlasSchema',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AtlasSchemaSpec defines the desired state of AtlasSchema"'),
  spec: {
    '#cloud':: d.obj(help='"Cloud defines the Atlas Cloud configuration."'),
    cloud: {
      '#tokenFrom':: d.obj(help='"TokenFrom defines the reference to the secret key that contains the Atlas Cloud Token."'),
      tokenFrom: {
        '#secretKeyRef':: d.obj(help='"SecretKeyRef references to the key of a secret in the same namespace."'),
        secretKeyRef: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { cloud+: { tokenFrom+: { secretKeyRef+: { key: key } } } } },
          ...
          withName(name): { spec+: { cloud+: { tokenFrom+: { secretKeyRef+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { cloud+: { tokenFrom+: { secretKeyRef+: { optional: optional } } } } },
        },
      },
      '#withRepo':: d.fn(help='"Repo is the name of repository on the Atlas Cloud."', args=[d.arg(name='repo', type=d.T.string)]),
      withRepo(repo): { spec+: { cloud+: { repo: repo } } },
    },
    '#configFrom':: d.obj(help='"ConfigFrom defines the reference to the secret key that contains the project configuration."'),
    configFrom: {
      '#secretKeyRef':: d.obj(help='"SecretKeyRef defines the secret key reference to use for the user."'),
      secretKeyRef: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { configFrom+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { configFrom+: { secretKeyRef+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { spec+: { configFrom+: { secretKeyRef+: { optional: optional } } } },
      },
    },
    '#credentials':: d.obj(help='"Credentials defines the credentials to use when connecting to the database.\\nUsed instead of URL or URLFrom."'),
    credentials: {
      '#hostFrom':: d.obj(help='"Secret defines a secret key reference."'),
      hostFrom: {
        '#secretKeyRef':: d.obj(help='"SecretKeyRef defines the secret key reference to use for the user."'),
        secretKeyRef: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { credentials+: { hostFrom+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { credentials+: { hostFrom+: { secretKeyRef+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { credentials+: { hostFrom+: { secretKeyRef+: { optional: optional } } } } },
        },
      },
      '#passwordFrom':: d.obj(help='"Secret defines a secret key reference."'),
      passwordFrom: {
        '#secretKeyRef':: d.obj(help='"SecretKeyRef defines the secret key reference to use for the user."'),
        secretKeyRef: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { credentials+: { passwordFrom+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { credentials+: { passwordFrom+: { secretKeyRef+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { credentials+: { passwordFrom+: { secretKeyRef+: { optional: optional } } } } },
        },
      },
      '#userFrom':: d.obj(help='"Secret defines a secret key reference."'),
      userFrom: {
        '#secretKeyRef':: d.obj(help='"SecretKeyRef defines the secret key reference to use for the user."'),
        secretKeyRef: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { credentials+: { userFrom+: { secretKeyRef+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { credentials+: { userFrom+: { secretKeyRef+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { credentials+: { userFrom+: { secretKeyRef+: { optional: optional } } } } },
        },
      },
      '#withDatabase':: d.fn(help='', args=[d.arg(name='database', type=d.T.string)]),
      withDatabase(database): { spec+: { credentials+: { database: database } } },
      '#withHost':: d.fn(help='', args=[d.arg(name='host', type=d.T.string)]),
      withHost(host): { spec+: { credentials+: { host: host } } },
      '#withParameters':: d.fn(help='', args=[d.arg(name='parameters', type=d.T.object)]),
      withParameters(parameters): { spec+: { credentials+: { parameters: parameters } } },
      ...
      withParametersMixin(parameters): { spec+: { credentials+: { parameters+: parameters } } },
    ...
    devDB: {
      ...
      spec: {
        ...
        affinity: {
          ...
          nodeAffinity: {
            ...
            requiredDuringSchedulingIgnoredDuringExecution: {
              ...
              withNodeSelectorTerms(nodeSelectorTerms): { spec+: { devDB+: { spec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } } },
              ...
              withNodeSelectorTermsMixin(nodeSelectorTerms): { spec+: { devDB+: { spec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } } },
            },
            ...
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
          ...
          podAffinity: {
            ...
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
          ...
          podAntiAffinity: {
            ...
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and subtracting\\n\\"weight\\" from the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and subtracting\\n\\"weight\\" from the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { devDB+: { spec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
        },
        ...
        dnsConfig: {
          ...
          withNameservers(nameservers): { spec+: { devDB+: { spec+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } } },
          ...
          withNameserversMixin(nameservers): { spec+: { devDB+: { spec+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } } },
          ...
          withOptions(options): { spec+: { devDB+: { spec+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } } } },
          ...
          withOptionsMixin(options): { spec+: { devDB+: { spec+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } } } },
          ...
          withSearches(searches): { spec+: { devDB+: { spec+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } } } },
          ...
          withSearchesMixin(searches): { spec+: { devDB+: { spec+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } } } },
        },
        ...
        os: {
          ...
          withName(name): { spec+: { devDB+: { spec+: { os+: { name: name } } } } },
        },
        ...
        resources: {
          ...
          '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
          withClaims(claims): { spec+: { devDB+: { spec+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } } },
          '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
          withClaimsMixin(claims): { spec+: { devDB+: { spec+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } } },
          '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
          withLimits(limits): { spec+: { devDB+: { spec+: { resources+: { limits: limits } } } } },
          '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
          withLimitsMixin(limits): { spec+: { devDB+: { spec+: { resources+: { limits+: limits } } } } },
          '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required.\\nIf Requests is omitted for a container, it defaults to Limits if that is explicitly specified,\\notherwise to an implementation-defined value. Requests cannot exceed Limits.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
          withRequests(requests): { spec+: { devDB+: { spec+: { resources+: { requests: requests } } } } },
          '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required.\\nIf Requests is omitted for a container, it defaults to Limits if that is explicitly specified,\\notherwise to an implementation-defined value. Requests cannot exceed Limits.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
          withRequestsMixin(requests): { spec+: { devDB+: { spec+: { resources+: { requests+: requests } } } } },
        },
        ...
        securityContext: {
          ...
          appArmorProfile: {
            '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { devDB+: { spec+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { devDB+: { spec+: { securityContext+: { appArmorProfile+: { type: type } } } } } },
          },
          '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to all containers.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in SecurityContext.  If set in\\nboth SecurityContext and PodSecurityContext, the value specified in SecurityContext\\ntakes precedence for that container.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seLinuxOptions: {
            '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
            withLevel(level): { spec+: { devDB+: { spec+: { securityContext+: { seLinuxOptions+: { level: level } } } } } },
            '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
            withRole(role): { spec+: { devDB+: { spec+: { securityContext+: { seLinuxOptions+: { role: role } } } } } },
            '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { devDB+: { spec+: { securityContext+: { seLinuxOptions+: { type: type } } } } } },
            '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
            withUser(user): { spec+: { devDB+: { spec+: { securityContext+: { seLinuxOptions+: { user: user } } } } } },
          },
          '#seccompProfile':: d.obj(help='"The seccomp options to use by the containers in this pod.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seccompProfile: {
            '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { devDB+: { spec+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { devDB+: { spec+: { securityContext+: { seccompProfile+: { type: type } } } } } },
          },
          ...
          windowsOptions: {
            '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
            withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { devDB+: { spec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } } },
            '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
            withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { devDB+: { spec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } } },
            '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
            withHostProcess(hostProcess): { spec+: { devDB+: { spec+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } } },
            '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
            withRunAsUserName(runAsUserName): { spec+: { devDB+: { spec+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } } },
          },
          ...
          withFsGroup(fsGroup): { spec+: { devDB+: { spec+: { securityContext+: { fsGroup: fsGroup } } } } },
          ...
          withFsGroupChangePolicy(fsGroupChangePolicy): { spec+: { devDB+: { spec+: { securityContext+: { fsGroupChangePolicy: fsGroupChangePolicy } } } } },
          '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
          withRunAsGroup(runAsGroup): { spec+: { devDB+: { spec+: { securityContext+: { runAsGroup: runAsGroup } } } } },
          '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
          withRunAsNonRoot(runAsNonRoot): { spec+: { devDB+: { spec+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } } },
          '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
          withRunAsUser(runAsUser): { spec+: { devDB+: { spec+: { securityContext+: { runAsUser: runAsUser } } } } },
          ...
          withSeLinuxChangePolicy(seLinuxChangePolicy): { spec+: { devDB+: { spec+: { securityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } } } },
          ...
          withSupplementalGroups(supplementalGroups): { spec+: { devDB+: { spec+: { securityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } } },
          ...
          withSupplementalGroupsMixin(supplementalGroups): { spec+: { devDB+: { spec+: { securityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } } },
          ...
          withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { devDB+: { spec+: { securityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } } } },
          ...
          withSysctls(sysctls): { spec+: { devDB+: { spec+: { securityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } } },
          ...
          withSysctlsMixin(sysctls): { spec+: { devDB+: { spec+: { securityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } } },
        },
        ...
        withActiveDeadlineSeconds(activeDeadlineSeconds): { spec+: { devDB+: { spec+: { activeDeadlineSeconds: activeDeadlineSeconds } } } },
        ...
        withAutomountServiceAccountToken(automountServiceAccountToken): { spec+: { devDB+: { spec+: { automountServiceAccountToken: automountServiceAccountToken } } } },
        ...
        withContainers(containers): { spec+: { devDB+: { spec+: { containers: if std.isArray(v=containers) then containers else [containers] } } } },
        ...
        withContainersMixin(containers): { spec+: { devDB+: { spec+: { containers+: if std.isArray(v=containers) then containers else [containers] } } } },
        ...
        withDnsPolicy(dnsPolicy): { spec+: { devDB+: { spec+: { dnsPolicy: dnsPolicy } } } },
        ...
        withEnableServiceLinks(enableServiceLinks): { spec+: { devDB+: { spec+: { enableServiceLinks: enableServiceLinks } } } },
        ...
        withEphemeralContainers(ephemeralContainers): { spec+: { devDB+: { spec+: { ephemeralContainers: if std.isArray(v=ephemeralContainers) then ephemeralContainers else [ephemeralContainers] } } } },
        ...
        withEphemeralContainersMixin(ephemeralContainers): { spec+: { devDB+: { spec+: { ephemeralContainers+: if std.isArray(v=ephemeralContainers) then ephemeralContainers else [ephemeralContainers] } } } },
        ...
        withHostAliases(hostAliases): { spec+: { devDB+: { spec+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } } },
        ...
        withHostAliasesMixin(hostAliases): { spec+: { devDB+: { spec+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } } },
        '#withHostIPC':: d.fn(help="\"Use the host's ipc namespace.\\nOptional: Default to false.\"", args=[d.arg(name='hostIPC', type=d.T.boolean)]),
        withHostIPC(hostIPC): { spec+: { devDB+: { spec+: { hostIPC: hostIPC } } } },
        ...
        withHostNetwork(hostNetwork): { spec+: { devDB+: { spec+: { hostNetwork: hostNetwork } } } },
        '#withHostPID':: d.fn(help="\"Use the host's pid namespace.\\nOptional: Default to false.\"", args=[d.arg(name='hostPID', type=d.T.boolean)]),
        withHostPID(hostPID): { spec+: { devDB+: { spec+: { hostPID: hostPID } } } },
        ...
        withHostUsers(hostUsers): { spec+: { devDB+: { spec+: { hostUsers: hostUsers } } } },
        ...
        withHostname(hostname): { spec+: { devDB+: { spec+: { hostname: hostname } } } },
        ...
        withHostnameOverride(hostnameOverride): { spec+: { devDB+: { spec+: { hostnameOverride: hostnameOverride } } } },
        ...
        withImagePullSecrets(imagePullSecrets): { spec+: { devDB+: { spec+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        ...
        withImagePullSecretsMixin(imagePullSecrets): { spec+: { devDB+: { spec+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        ...
        withInitContainers(initContainers): { spec+: { devDB+: { spec+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } } } },
        ...
        withInitContainersMixin(initContainers): { spec+: { devDB+: { spec+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } } } },
        ...
        withNodeName(nodeName): { spec+: { devDB+: { spec+: { nodeName: nodeName } } } },
        ...
        withNodeSelector(nodeSelector): { spec+: { devDB+: { spec+: { nodeSelector: nodeSelector } } } },
        ...
        withNodeSelectorMixin(nodeSelector): { spec+: { devDB+: { spec+: { nodeSelector+: nodeSelector } } } },
        ...
        withOverhead(overhead): { spec+: { devDB+: { spec+: { overhead: overhead } } } },
        ...
        withOverheadMixin(overhead): { spec+: { devDB+: { spec+: { overhead+: overhead } } } },
        ...
        withPreemptionPolicy(preemptionPolicy): { spec+: { devDB+: { spec+: { preemptionPolicy: preemptionPolicy } } } },
        ...
        withPriority(priority): { spec+: { devDB+: { spec+: { priority: priority } } } },
        ...
        withPriorityClassName(priorityClassName): { spec+: { devDB+: { spec+: { priorityClassName: priorityClassName } } } },
        ...
        withReadinessGates(readinessGates): { spec+: { devDB+: { spec+: { readinessGates: if std.isArray(v=readinessGates) then readinessGates else [readinessGates] } } } },
        ...
        withReadinessGatesMixin(readinessGates): { spec+: { devDB+: { spec+: { readinessGates+: if std.isArray(v=readinessGates) then readinessGates else [readinessGates] } } } },
        ...
        withResourceClaims(resourceClaims): { spec+: { devDB+: { spec+: { resourceClaims: if std.isArray(v=resourceClaims) then resourceClaims else [resourceClaims] } } } },
        ...
        withResourceClaimsMixin(resourceClaims): { spec+: { devDB+: { spec+: { resourceClaims+: if std.isArray(v=resourceClaims) then resourceClaims else [resourceClaims] } } } },
        ...
        withRestartPolicy(restartPolicy): { spec+: { devDB+: { spec+: { restartPolicy: restartPolicy } } } },
        ...
        withRuntimeClassName(runtimeClassName): { spec+: { devDB+: { spec+: { runtimeClassName: runtimeClassName } } } },
        ...
        withSchedulerName(schedulerName): { spec+: { devDB+: { spec+: { schedulerName: schedulerName } } } },
        ...
        withSchedulingGates(schedulingGates): { spec+: { devDB+: { spec+: { schedulingGates: if std.isArray(v=schedulingGates) then schedulingGates else [schedulingGates] } } } },
        ...
        withSchedulingGatesMixin(schedulingGates): { spec+: { devDB+: { spec+: { schedulingGates+: if std.isArray(v=schedulingGates) then schedulingGates else [schedulingGates] } } } },
        ...
        withServiceAccount(serviceAccount): { spec+: { devDB+: { spec+: { serviceAccount: serviceAccount } } } },
        ...
        withServiceAccountName(serviceAccountName): { spec+: { devDB+: { spec+: { serviceAccountName: serviceAccountName } } } },
        ...
        withSetHostnameAsFQDN(setHostnameAsFQDN): { spec+: { devDB+: { spec+: { setHostnameAsFQDN: setHostnameAsFQDN } } } },
        ...
        withShareProcessNamespace(shareProcessNamespace): { spec+: { devDB+: { spec+: { shareProcessNamespace: shareProcessNamespace } } } },
        ...
        withSubdomain(subdomain): { spec+: { devDB+: { spec+: { subdomain: subdomain } } } },
        ...
        withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { spec+: { devDB+: { spec+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } } },
        '#withTolerations':: d.fn(help="\"If specified, the pod's tolerations.\"", args=[d.arg(name='tolerations', type=d.T.array)]),
        withTolerations(tolerations): { spec+: { devDB+: { spec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        ...
        withTolerationsMixin(tolerations): { spec+: { devDB+: { spec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        ...
        withTopologySpreadConstraints(topologySpreadConstraints): { spec+: { devDB+: { spec+: { topologySpreadConstraints: if std.isArray(v=topologySpreadConstraints) then topologySpreadConstraints else [topologySpreadConstraints] } } } },
        ...
        withTopologySpreadConstraintsMixin(topologySpreadConstraints): { spec+: { devDB+: { spec+: { topologySpreadConstraints+: if std.isArray(v=topologySpreadConstraints) then topologySpreadConstraints else [topologySpreadConstraints] } } } },
        ...
        withVolumes(volumes): { spec+: { devDB+: { spec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } } },
        ...
        withVolumesMixin(volumes): { spec+: { devDB+: { spec+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } } },
      },
    },
    '#devURLFrom':: d.obj(help='"DevURLFrom is a reference to a secret containing the URL of the database to use for normalization and calculations."'),
    devURLFrom: {
      '#secretKeyRef':: d.obj(help='"SecretKeyRef defines the secret key reference to use for the user."'),
      secretKeyRef: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { devURLFrom+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { devURLFrom+: { secretKeyRef+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { spec+: { devURLFrom+: { secretKeyRef+: { optional: optional } } } },
      },
    },
    '#policy':: d.obj(help='"Policy defines the policies to apply when managing the schema change lifecycle."'),
    policy: {
      '#diff':: d.obj(help='"Diff defines the diff policies to apply when planning schema changes."'),
      diff: {
        '#concurrent_index':: d.obj(help=''),
        concurrent_index: {
          '#withCreate':: d.fn(help='', args=[d.arg(name='create', type=d.T.boolean)]),
          withCreate(create): { spec+: { policy+: { diff+: { concurrent_index+: { create: create } } } } },
          '#withDrop':: d.fn(help='', args=[d.arg(name='drop', type=d.T.boolean)]),
          withDrop(drop): { spec+: { policy+: { diff+: { concurrent_index+: { drop: drop } } } } },
        },
        '#skip':: d.obj(help='"SkipChanges represents the skip changes policy."'),
        skip: {
          '#withAdd_column':: d.fn(help='', args=[d.arg(name='add_column', type=d.T.boolean)]),
          withAdd_column(add_column): { spec+: { policy+: { diff+: { skip+: { add_column: add_column } } } } },
          '#withAdd_foreign_key':: d.fn(help='', args=[d.arg(name='add_foreign_key', type=d.T.boolean)]),
          withAdd_foreign_key(add_foreign_key): { spec+: { policy+: { diff+: { skip+: { add_foreign_key: add_foreign_key } } } } },
          '#withAdd_index':: d.fn(help='', args=[d.arg(name='add_index', type=d.T.boolean)]),
          withAdd_index(add_index): { spec+: { policy+: { diff+: { skip+: { add_index: add_index } } } } },
          '#withAdd_schema':: d.fn(help='', args=[d.arg(name='add_schema', type=d.T.boolean)]),
          withAdd_schema(add_schema): { spec+: { policy+: { diff+: { skip+: { add_schema: add_schema } } } } },
          '#withAdd_table':: d.fn(help='', args=[d.arg(name='add_table', type=d.T.boolean)]),
          withAdd_table(add_table): { spec+: { policy+: { diff+: { skip+: { add_table: add_table } } } } },
          '#withDrop_column':: d.fn(help='', args=[d.arg(name='drop_column', type=d.T.boolean)]),
          withDrop_column(drop_column): { spec+: { policy+: { diff+: { skip+: { drop_column: drop_column } } } } },
          '#withDrop_foreign_key':: d.fn(help='', args=[d.arg(name='drop_foreign_key', type=d.T.boolean)]),
          withDrop_foreign_key(drop_foreign_key): { spec+: { policy+: { diff+: { skip+: { drop_foreign_key: drop_foreign_key } } } } },
          '#withDrop_index':: d.fn(help='', args=[d.arg(name='drop_index', type=d.T.boolean)]),
          withDrop_index(drop_index): { spec+: { policy+: { diff+: { skip+: { drop_index: drop_index } } } } },
          '#withDrop_schema':: d.fn(help='', args=[d.arg(name='drop_schema', type=d.T.boolean)]),
          withDrop_schema(drop_schema): { spec+: { policy+: { diff+: { skip+: { drop_schema: drop_schema } } } } },
          '#withDrop_table':: d.fn(help='', args=[d.arg(name='drop_table', type=d.T.boolean)]),
          withDrop_table(drop_table): { spec+: { policy+: { diff+: { skip+: { drop_table: drop_table } } } } },
          '#withModify_column':: d.fn(help='', args=[d.arg(name='modify_column', type=d.T.boolean)]),
          withModify_column(modify_column): { spec+: { policy+: { diff+: { skip+: { modify_column: modify_column } } } } },
          '#withModify_foreign_key':: d.fn(help='', args=[d.arg(name='modify_foreign_key', type=d.T.boolean)]),
          withModify_foreign_key(modify_foreign_key): { spec+: { policy+: { diff+: { skip+: { modify_foreign_key: modify_foreign_key } } } } },
          '#withModify_index':: d.fn(help='', args=[d.arg(name='modify_index', type=d.T.boolean)]),
          withModify_index(modify_index): { spec+: { policy+: { diff+: { skip+: { modify_index: modify_index } } } } },
          '#withModify_schema':: d.fn(help='', args=[d.arg(name='modify_schema', type=d.T.boolean)]),
          withModify_schema(modify_schema): { spec+: { policy+: { diff+: { skip+: { modify_schema: modify_schema } } } } },
          '#withModify_table':: d.fn(help='', args=[d.arg(name='modify_table', type=d.T.boolean)]),
          withModify_table(modify_table): { spec+: { policy+: { diff+: { skip+: { modify_table: modify_table } } } } },
        },
      },
      '#lint':: d.obj(help='"Lint defines the linting policies to apply before applying the schema."'),
      lint: {
        '#destructive':: d.obj(help='"CheckConfig defines the configuration of a linting check."'),
        destructive: {
          '#withError':: d.fn(help='', args=[d.arg(name='err', type=d.T.boolean)]),
          withError(err): { spec+: { policy+: { lint+: { destructive+: { 'error': err } } } } },
        },
        '#withReview':: d.fn(help='"Review defines the review policy to apply after linting the schema changes (default: \\"ERROR\\").\\nAtlas Cloud login is required."', args=[d.arg(name='review', type=d.T.string)]),
        withReview(review): { spec+: { policy+: { lint+: { review: review } } } },
      },
    },
    '#schema':: d.obj(help='"Desired Schema of the target."'),
    schema: {
      '#configMapKeyRef':: d.obj(help='"Selects a key from a ConfigMap."'),
      configMapKeyRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { schema+: { configMapKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { schema+: { configMapKeyRef+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { spec+: { schema+: { configMapKeyRef+: { optional: optional } } } },
      },
      '#withHcl':: d.fn(help='', args=[d.arg(name='hcl', type=d.T.string)]),
      withHcl(hcl): { spec+: { schema+: { hcl: hcl } } },
      '#withSql':: d.fn(help='', args=[d.arg(name='sql', type=d.T.string)]),
      withSql(sql): { spec+: { schema+: { sql: sql } } },
      '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { schema+: { url: url } } },
    },
    '#urlFrom':: d.obj(help='"URLs may be defined as a secret key reference."'),
    urlFrom: {
      '#secretKeyRef':: d.obj(help='"SecretKeyRef defines the secret key reference to use for the user."'),
      secretKeyRef: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { urlFrom+: { secretKeyRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { urlFrom+: { secretKeyRef+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { spec+: { urlFrom+: { secretKeyRef+: { optional: optional } } } },
      },
    },
    '#vars':: d.obj(help='"Vars defines the input variables for the project configuration."'),
    vars: {
      '#valueFrom':: d.obj(help='"ValueFrom defines the reference to the secret key that contains the value."'),
      valueFrom: {
        '#configMapKeyRef':: d.obj(help='"ConfigMapKeyRef defines the configmap key reference to use for the value."'),
        configMapKeyRef: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { valueFrom+: { configMapKeyRef+: { key: key } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        ...
        '#secretKeyRef':: d.obj(help='"SecretKeyRef defines the secret key reference to use for the value."'),
        secretKeyRef: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { valueFrom+: { secretKeyRef+: { key: key } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#withBackoffLimit':: d.fn(help='"BackoffLimit is the number of retries on error."', args=[d.arg(name='backoffLimit', type=d.T.integer)]),
    withBackoffLimit(backoffLimit): { spec+: { backoffLimit: backoffLimit } },
    '#withConfig':: d.fn(help='"Config defines the project configuration.\\nShould be a valid YAML string."', args=[d.arg(name='config', type=d.T.string)]),
    withConfig(config): { spec+: { config: config } },
    '#withDevURL':: d.fn(help='"DevURL is the URL of the database to use for normalization and calculations.\\nIf not specified, the operator will spin up a temporary database container to use for these operations."', args=[d.arg(name='devURL', type=d.T.string)]),
    withDevURL(devURL): { spec+: { devURL: devURL } },
    '#withEnvName':: d.fn(help='"EnvName defines the environment name that defined in the project configuration.\\nIf not defined, the default environment \\"k8s\\" will be used."', args=[d.arg(name='envName', type=d.T.string)]),
    withEnvName(envName): { spec+: { envName: envName } },
    '#withExclude':: d.fn(help='"Exclude a list of glob patterns used to filter existing resources being taken into account."', args=[d.arg(name='exclude', type=d.T.array)]),
    withExclude(exclude): { spec+: { exclude: if std.isArray(v=exclude) then exclude else [exclude] } },
    '#withExcludeMixin':: d.fn(help='"Exclude a list of glob patterns used to filter existing resources being taken into account."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='exclude', type=d.T.array)]),
    withExcludeMixin(exclude): { spec+: { exclude+: if std.isArray(v=exclude) then exclude else [exclude] } },
    '#withSchemas':: d.fn(help='"The names of the schemas (named databases) on the target database to be managed."', args=[d.arg(name='schemas', type=d.T.array)]),
    withSchemas(schemas): { spec+: { schemas: if std.isArray(v=schemas) then schemas else [schemas] } },
    '#withSchemasMixin':: d.fn(help='"The names of the schemas (named databases) on the target database to be managed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='schemas', type=d.T.array)]),
    withSchemasMixin(schemas): { spec+: { schemas+: if std.isArray(v=schemas) then schemas else [schemas] } },
    '#withTxMode':: d.fn(help='"TxMode defines the transaction mode to use when applying the schema."', args=[d.arg(name='txMode', type=d.T.string)]),
    withTxMode(txMode): { spec+: { txMode: txMode } },
    '#withUrl':: d.fn(help='"URL of the target database schema."', args=[d.arg(name='url', type=d.T.string)]),
    withUrl(url): { spec+: { url: url } },
    '#withVars':: d.fn(help='"Vars defines the input variables for the project configuration."', args=[d.arg(name='vars', type=d.T.array)]),
    withVars(vars): { spec+: { vars: if std.isArray(v=vars) then vars else [vars] } },
    '#withVarsMixin':: d.fn(help='"Vars defines the input variables for the project configuration."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='vars', type=d.T.array)]),
